...
import { a as hasGateSessionMarker, t as GROK_PROVIDERS } from "./server-BIzPmpE7.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/button-B9YO6td8.js
...
/** Merge Tailwind classes without style clashes. */
function cn(...inputs) {
	return twMerge(clsx(inputs));
}
var buttonVariants = cva("inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors duration-[var(--motion-fast,250ms)] disabled:pointer-events-none disabled:opacity-40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring", {
	variants: {
		variant: {
			...
			crimson: "bg-crimson text-bone hover:bg-crimson/90"
		},
		size: {
			default: "h-11 px-4",
			sm: "h-9 px-3 text-xs",
...
//#endregion
export { SignedOut as a, useCurrentUserState as c, SignedIn as i, RedirectToSignIn as n, UserButton as o, SignInGate as r, cn as s, Button as t };
